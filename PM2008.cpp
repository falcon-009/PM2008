...
void PM2008::begin(HardwareSerial *serial)
{
    ptrSerial = serial;
...
boolean PM2008::command(byte cmd, byte data[], int data_len, int resp_len)
{
    boolean res = false;
...
void PM2008::getSerialNumber(void)
{
  // Read Serial number
  resp_len = 14;
